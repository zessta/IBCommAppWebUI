...
import { Backdrop, Box, Button, Modal, SxProps, TextField, Theme, Typography } from "@mui/material";
import React, { useEffect, useState } from "react";
import CloseIcon from "../assets/CloseIcon.svg";
import { getUserForRole } from "../api/requests/users";

const UserRoleModal = ({open, rank, handleClose}:{open:boolean, rank:any, handleClose:()=>void}) => {
            ...
            <Box sx={boxStyles}>
                ...
                {users && users.length > 0 ? (
                    <>
                        ...
                        <Box sx={{display:"flex", justifyContent:"flex-end", mt:"auto", gap:2}}>
